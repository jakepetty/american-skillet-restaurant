...
@endsection
@section('content')
<section class="page-title parallax" data-parallax="scroll" data-image-src="/img/about-bg.jpg">
    <div class="container">
        <h1>About Us</h1>
    </div>
</section>
<section id="about">
    <div class="container">
        ...
        <p>
            Lidia, Naim, and Tony Kassouf would like to welcome you to American Skillet's web page. We hope you find our
            ...
            lunch for over 12 years.
        </p>
        <p>
            For the many years that lead up to opening the doors, Lidia, then a homemaker, had envisioned a partnership
            ...
            prepping stations and prepared her famous homemade soups, while Tony cooked and waited tables.
        </p>
        <p>
            Because of demand from our NW side customers, the time came in 2005 to open an American Skillet on the other
        ...
        <p>
            Lidia's vision of working with her son came through, and since then, the family of American Skillet has
            ...
            contact Tony here or email: <strong>tony@cibofusion.com</strong>
        </p>
    </div>
</section>
<section class="section parallax" style="height:35%" data-parallax="scroll"
    data-image-src="/img/hero-bg.jpg"></section>
<section id="staff">
    <div class="container">
        <header>
            <p>Meet Our</p>
